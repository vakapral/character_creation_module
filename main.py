"""Модуль выбора и тренировки персонажа.
"""
...
def attack(char_name: str, char_class: str) -> str:
    ...
    Key arguments:
    char_name -- character's name (default '')
    char_class -- choosen class for a character (default '')
    """
